          ...
          <DialogContent className="w-[calc(100vw-2rem)] max-w-2xl overflow-x-hidden">
            ...
            <form onSubmit={handleCreateOrder} className="max-h-[calc(100vh-10rem)] space-y-5 overflow-y-auto px-1 pb-1">
              ...
              <section className="grid gap-4 sm:grid-cols-2">
                ...
                <div><Label htmlFor="new-order-value">Valeur (€)</Label><Input id="new-order-value" required type="number" min="0" step="0.01" inputMode="decimal" className="mt-1" value={createOrder.value} onChange={(e) => setCreateOrder({ ...createOrder, value: e.target.value })} /></div>
                <div className="sm:col-span-2"><Label htmlFor="new-order-description">Description</Label><Textarea id="new-order-description" required className="mt-1" rows={2} value={createOrder.description} onChange={(e) => setCreateOrder({ ...createOrder, description: e.target.value })} /></div>
              </section>
              ...
              <section className="space-y-3 rounded-xl border p-4">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  <div><Label htmlFor="recipient-phone">Téléphone (facultatif)</Label><Input id="recipient-phone" type="tel" autoComplete="tel" value={createOrder.recipient_phone} onChange={(e) => setCreateOrder({ ...createOrder, recipient_phone: e.target.value })} /></div>
                  ...
                  <div><Label htmlFor="recipient-postal">Code postal (facultatif)</Label><Input id="recipient-postal" autoComplete="postal-code" value={createOrder.recipient_postal_code} onChange={(e) => setCreateOrder({ ...createOrder, recipient_postal_code: e.target.value })} /></div>
