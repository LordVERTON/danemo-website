...
- [x] **Navigation administration — P0.** La barre basse comporte, de gauche à droite, **Clients**, **Suivi**, **Scanner**, **Conteneurs** et **Plus**. Le tableau de bord reste accessible par le logo et masque sur mobile ses raccourcis redondants Clients, Conteneurs, Suivi et Blogs ; « Plus » contient les Blogs, les sections secondaires selon le rôle et la déconnexion. Les contrôles de rôle, l'état actif et la fermeture après navigation sont conservés. Critère de recette : aucun libellé tronqué et chaque accès mesure au moins 44 × 44 px à 320 px. *(Livré le 10/09/2026.)*
...
- [ ] **Listes métier sous forme de cartes — P0.** Prévoir une vue carte sous `lg` pour les clients, commandes et suivi ; ne conserver les tableaux denses qu'à partir du bureau. Chaque carte expose la donnée principale, le statut, le contexte indispensable et une action explicite « Voir »/« Modifier ». Critère de recette : les parcours client, commande, suivi et conteneur se font sans balayage horizontal. *(En cours le 11/09/2026 : vues carte livrées pour les clients, le suivi et les conteneurs ; la liste générale des commandes reste à généraliser.)*
