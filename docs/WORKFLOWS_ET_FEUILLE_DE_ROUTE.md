...
- [ ] **Modales, clavier et actions de formulaire — P0.** Normaliser toutes les modales : largeur adaptée, hauteur maximale de 90 vh, contenu défilable, fermeture explicite et bouton principal atteignable avec le clavier ouvert. Critère de recette : création d'un client, commande et règlement possible sur iPhone et Android sans perdre la saisie. *(En cours le 06/09/2026 : composants de modale normalisés et actions de commande stabilisées.)*
