...
- [x] **Navigation administration — P0.** La barre basse comporte, de gauche à droite, **Clients**, **Conteneurs**, **Scanner**, **Suivi** et **Plus**. Le tableau de bord reste accessible par le logo et masque sur mobile ses raccourcis redondants Clients, Conteneurs, Suivi et Blogs ; « Plus » contient les Blogs et la déconnexion pour un opérateur, ainsi que les Analyses, Messages et Collaborateurs pour un administrateur. Les contrôles de rôle, l'état actif et la fermeture après navigation sont conservés. Critère de recette : aucun libellé tronqué et chaque accès mesure au moins 44 × 44 px à 320 px. *(Mis à jour le 11/09/2026.)*
- [x] **En-tête admin à 320 px — P0.** Le logo conserve le retour au tableau de bord ; la déconnexion est déplacée dans « Plus » et affichée en rouge. Critère de recette : connexion, tableau de bord et déconnexion utilisables à 320 px sans zoom ni défilement horizontal. *(Livré le 10/09/2026.)*
- [x] **Listes métier sous forme de cartes — P0.** Les clients, conteneurs et le suivi utilisent désormais une liste compacte sur tous les écrans, sans tableau dense : donnée principale, statut, contexte indispensable et action explicite. Dans **Suivi**, l'action principale « Suivi » ouvre l'historique de la commande et le bouton « + » ouvre sa création avec recherche ou création d'un client. Critère de recette : les parcours client, commande, suivi et conteneur se font sans balayage horizontal. *(Mis à jour le 11/09/2026.)*
